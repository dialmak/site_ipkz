...
|---|---|---|---|---|---|---|
|Стан перетворювача| &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; |
|0 | Стан перетворювача ІПКЗ | Тільки читання (R) | Число від 0 до 5 | - | Число від 0 до 5 0 : Стан в нормі;1 : Немає мережі 230 В;2 : Помилка силового блоку;3 : Сигналізація про високу, понад 75&deg;C, внутрішню температуру силового блоку;4 : Спрацював захист від перенапруги;5 : Спрацював захист від перевантаження;| `int16_t` |
| Основні показники |  &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; |
| 1 | Режим роботи | Тільки читання (R) | Від 0 до 3 | - | Число від 0 до 3 0 : Вихід вимкнений;1 : Стабілізація напруги;2 : Стабілізація струму;3 : Стабілізація потенціалу; |  `int16_t` |
...
| &nbsp; |Стан дверцят шафи ІПКЗ|Тільки читання (R)|Число від 0 до 1|-|Число від 0 до 1 0 : Дверцята закриті;1 : Дверцята відкриті;| `int16_t` |
| &nbsp; |Стан зовнішніх дверей|Тільки читання (R)|Число від 0 до 1|-|Число від 0 до 1 0 : Двері закриті;1 : Двері відкриті| `int16_t` |
| &nbsp; |Стан мережі 230V|Тільки читання (R)|Число від 0 до 1|-|Число від 0 до 1 0 : Мережі немає;1 : Мережа є;| `int16_t` |
| &nbsp; |Стан ланцюгів навантаження|Тільки читання (R)|Число від 0 до 2|&shy;-|Число від 0 до 2 0 : Норма;1 : Обрив;2 : Коротке замикання;| `int16_t` |
| &nbsp; |Стан вимірювальних ланцюгів від електрода порівняння|Тільки читання (R)|Число від 0 до 2|-|Число від 0 до 2 0 : Норма;1 : Обрив;2 : Коротке замикання;| `int16_t` |
...
| 22 | Керування режимом роботи | Читання та запис (R/W) | Число від 0 до 3 | - |Число від 0 до 30 : Вимкнути вихід; 1 : Режим стабілізації напруги;2 : Режим стабілізації струму;3 : Режим стабілізації потенціалу;| `int16_t` |
...
| 28 | Режим роботи ПІД регулятора | Читання та запис (R/W) | Від 0 до 1 | - | Число від 0 до 1 0 : Стандартний режим; 1 : Ручний режим;| `int16_t` |
