...
!!! tip "Відкриття Веб-інтерфейсу по IP адресі"
    ...
    - Підключіться до точки доступу перетворювача, її назва починається з `IPKZ-`.
...
- Погана якість зв'язку <img src = "../assets/svg/wifi3.svg"/>
- З'єднання втрачено <img src = "../assets/svg/wifi4.svg"/>
