...
!!! tip "Відкриття Веб-інтерфейсу по IP адресі"
    Якщо по будь-яким причинам не влаштовує автоматичне відкриття бразуера після підключення до точки доступа перетворювача, то є моживість відкриття Веб-інтерфейсу вручну. 

    1. Підключіться до точки доступу перетворювача, її назва починається з `IPKZ-`.
    2. Відкрийте улюблений браузер.
    3. В адресному рядку браузера наберіть адресу 10.10.10.10 й перейдіть на цю адресу.   
...
!!! note "Якщо є підозра, що сторінка зависла"
    ...
    В Android та iOS через пункт меню :material-refresh: або свайпом з середини екрану донизу.   
...
=== "Скріншот сторінки"
    ...
    ![Cторінка Про перетворювач.](../assets/images/about/about-full.png){ width="200"}
...
- [x] Зайти в системне меню (1) Веб-інтерфейсу, клацнувши :material-menu: .
- [x] Клацнути на піктограмі (2) й вибрати файл прошивки.
...
2. ![Оновлення ПЗ.](../assets/images/main/update.png)
