...
***Для відключення виходу або переходу в режим стабілізації напруги, струму чи потенціалу:*** 
...
***Перехід на сторінку *Налаштування* в один крок:***
...
***Для зміни бітрейта RS-485 порта:***
...
!!! tip "Важливо!"
    Допустимий діапазон значеннь.

    | **Допустимий діапазон показника лічильника, kW⋅h** | **Допустимий діапазон кількісті імпульсів за kW⋅h, imp/kW⋅h** |
    |---|---| 
    | Від 0 до 999999.999 | Від 100 до 10000 |

    При введенні значення поза діапазоном - з'явиться спливаюче червоне вікно з помилкою.

### Вибір мови інтерфейсу { #settings-language data-toc-label='Мова інтерфейсу' }
